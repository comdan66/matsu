...
$(function () {
  ...
  function setMapData (key, lineSymbols, points, markers, speed, lineColor) {
    ...
    window['line_' + key] = new google.maps.Polyline ({
      ...
      icons: lineSymbols.map (function (t) { return {icon: t, offset: '100%'};})
    });
  ...
  function initialize () {
    ...
    var lineSymbols = [{
        ...
        {
          path: circlePath (0, 0, 2.7),
          strokeColor: 'rgba(145, 15, 15, 1)',
          strokeWeight: 1.5,
          fillColor: 'rgba(220, 78, 75, 1)',
          fillOpacity: 1
        }
        ];
    ...
    setMapData ('pm19', lineSymbols, points, markers, 1/4, 'rgba(15, 36, 141, .5)');
