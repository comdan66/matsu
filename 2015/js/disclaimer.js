...
$(function () {
  var datas = [
    ...
    },
    {
      t: '最後',
      vs: [
        '還是要說一下，站內多數資料多數是參考網路上資源以及前輩們對於地方研究敘述的資料！如要引用，請標明出處或告知原作者！另外，若站上的資訊有錯誤或有不妥，歡迎各位<a href="mailto:comdan66@gmail.com?subject=關於北港迎媽祖網頁..&body=Hi OA,%0d%0a%0d%0a    關於北港迎媽祖網頁，我有些相關問題..">來信</a>指導、建議。'
      ]
    }
  ];
