  ...
  var units = [
    {
      a: 'left',
      is: [
        {s: '01-01.jpg', t: '2011年受中華民國行政院文建會指定為國家重要民俗'},
        {s: '01-02.jpg', t: '報馬仔一到，就知道準備要開始了！'},
        {s: '01-03.jpg', t: '虎爺會也一早就到廟埕集合'}
      ],
      vs: [
    ...
    },
    {
      a: 'right',
      is: [
        {s: '02-01.jpg', t: '唱班儀式喊完，全鎮歡騰！'},
        {s: '02-02.jpg', t: '起馬炮驚聲全場'},
        {s: '02-03.jpg', t: '金垂髫的小朋友們'},
        {s: '02-04.jpg', t: '青紅將軍開路展威風'}
      ],
      vs: [
    ...
    },
    {
      a: 'left',
      is: [
        {s: '03-01.jpg', t: '虎爺風來虎煞喫炮囉！'},
        {s: '03-02.jpg', t: '家家戶戶大都在辦桌'},
        {s: '03-03.jpg', t: '夜間場即將開始'},
        {s: '03-04.jpg', t: 'ㄌㄨㄚˋ炮(犁炮)手就位！'}
      ],
      vs: [
    ...
    },
    {
      a: 'right',
      is: [
        {s: '04-01.jpg', t: '漂亮的藝閣花車'},
        {s: '04-02.jpg', t: '拍拍手接糖果！'},
        {s: '04-03.jpg', t: '霓彩妝童延續傳統文化風華'}
      ],
      vs: [
        '<br />',
    ...
    },
    {
      a: 'left',
      is: [
        {s: '05-01.jpg', t: '夜晚的陣頭更加絢彩'},
        {s: '05-02.jpg', t: '虎爺炮推更是喫不停'},
        {s: '05-03.jpg', t: '三天兩夜，圓滿結束前的最後衝刺！'},
        {s: '05-04.jpg', t: '兩聲哨鼓的北港黃袍勇士'},
        {s: '05-05.jpg', t: '雖然滿身炮灰但赤誠的心就像轎上的鮮花一樣清亮'},
      ],
      vs: [
        '<br />',
        '<br />',
